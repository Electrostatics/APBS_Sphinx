...
from plugins.ParseIn import parameter
from plugins.ParseIn.elec_parser import Elec
from plugins.ParseIn.apolar_parser import Apolar
from plugins.ParseIn.print_parser import Print
from plugins.ParseIn.read_parser import Read
